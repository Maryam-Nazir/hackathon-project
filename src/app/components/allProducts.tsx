...
export default function AllProduct() {
  const products: Product[] = [
    ...
    { id: 3, title: "Library Stool Chair", price: 20, image: "/stool.jpg" },
    { id: 4, title: "Library Stool Chair", price: 20, image: "/chair2.jpg" },
    {
      id: 5,
      title: "Library Stool Chair",
      price: 20,
    ...
    { id: 7, title: "Library Stool Chair", price: 20, image: "/chair5.jpg" },
    { id: 8, title: "Library Stool Chair", price: 20, image: "/stools.jpg" },
  ];
